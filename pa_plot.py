...
def plot_defusion_length_row_dependence(
    ...
    **kwargs
    ...
    """
    plots defusion length in dependence of y-axis for multiple voltage values.
    if you are here to change the look of your data call this function within this file
    and execute the code.
    if you did not change the location where the .pkl file is stored you do not need to
    worry about changing the pickle_name. 
    It should in this case be correct and access the values of your latest compilation.
    """
    #default settings
    kwargs.setdefault("title", "")
    kwargs.setdefault("x_label", "Position entlang der y-Koordinate")
    kwargs.setdefault("y_label", "Diffusionslänge (\u03BCm)")
    kwargs.setdefault("voltage_label", "Spannung")
    ...
    kwargs["voltage_label"] += " (" + volt_unit + ")"
...
def plot_multiple_diffusion_length_voltage_dependence(
    ...
    **kwargs
    ...
    """
    plots diffusion length in dependence of the voltage.
    if you are here to change the look of your data call this function within this file
    and execute the code.
    if you did not change the location where the .pkl file is stored you do not need to
    worry about changing the pickle_name. 
    ...
    #default settings
    kwargs.setdefault("title", "")
    kwargs.setdefault("x_label", "Spannung")
    kwargs.setdefault("y_label", "Diffusionslänge (\u03BCm)")
    kwargs.setdefault("figsize", [3.4, 2.7])
...
def plot_exp(
    ...
    **kwargs
    ...
    """
    plots gray value in dependence of the position along x axis.
    if you are here to change the look of your data call this function within this file
    and execute the code.
    if you did not change the location where the .pkl file is stored you only need
    to replace  "last_ef_highest-fixed.pkl" in the .pkl name with the correct file.
    If you do not know the name go to "Pickle_data/Exponential_fit" in your file organizer.
    """
    #default settings
    kwargs.setdefault("title", "")
    kwargs.setdefault("x_label", "Position entlang der x-Koordinate")
    kwargs.setdefault("y_label", "Grauwert")
    kwargs.setdefault("figsize", [3.4, 2.7])
    kwargs.setdefault("grid", False)
    kwargs.setdefault("linewidth", 1)
    kwargs.setdefault("linestyle", "-")
    ...
    kwargs.setdefault("fit_label", "exponentieller Fit")
    kwargs.setdefault("data_label", "gemessene Datenpunkte")
